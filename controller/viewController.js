...
exports.alerts = (req,res,next)=>{
    ...
    if(alert === 'booking') res.locals.alert = 'Your booking was successful! please check your email for a confirmation. if your booking doesn\'t show immediately check back later';
    next();
}
