...
const tourSchema = new mongoose.Schema({
  name:{
    type:String,
    required:[true,'A tour name is very required bro'],
    unique:true,
    trim:true
  },
  slug:String,
  duration:{
    type: Number,
    required:[true,'A tour duramtion is required']
  },
  maxGroupSize:{
    type: Number,
...
// embedded the users in the tour schema
...
//   console.log(`it took ${Date.now()-this.start} mm`);
//   next();
// })
