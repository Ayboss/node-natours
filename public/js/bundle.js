...
const bookTour = async tourId => {
  try {
    const session = await (0, _axios.default)(`http://localhost:3000/api/v1/bookings/checkout-session/${tourId}`);
    console.log(session);
...
const displayMap = locations => {
  ...
  locations.forEach(loc => {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML(`<p>Day ${loc.day}: ${loc.description}</p>`).addTo(map); //extends map bounds to include current locations
...
if (loginSubmit) {
  loginSubmit.addEventListener('click', function (e) {
    ...
    const password = document.getElementById('password').value; // console.log(email, password);
...
},{"./login":"login.js","./updateSettings":"updateSettings.js","./stripe":"stripe.js","./mapbox":"mapbox.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
